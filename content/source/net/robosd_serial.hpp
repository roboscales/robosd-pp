...
namespace robo {
	namespace net {
		...
		public:
			...
			virtual bool put(uint8_t* _data, size_t _size) = 0;
		...
		public:
			...
			virtual bool put(uint8_t* _data, size_t _size);
		...
		public:
			...
			public:
				virtual size_t available(void) {
					G g__;
					return owner_.incom_.count();
				}
				virtual size_t space(void) {
					G g__;
					return owner_.outcom_.space();
				}
				virtual size_t get(uint8_t* _data, size_t _max_size) {
					G g__;
					return owner_.incom_.get(_data, _max_size);
				}
				virtual bool put(uint8_t* _data, size_t _size) {
					G g__;
					return owner_.outcom_.put(_data, _size);
				}
				virtual uint8_t get(void) {
					G g__;
					if (owner_.incom_.count() > 0) {
						return owner_.incom_.get();
					}
					else {
						return 0;
					}
				...
				virtual bool  put(uint8_t _data) {
					G g__;
					if (owner_.outcom_.space() > 0) {
						owner_.outcom_.put(_data);
						return true;
					}
					else {
						return false;
			...
			public:
				virtual size_t available(void) {
					G g__;
					return owner_.outcom_.count();
				}
				virtual size_t space(void) {
					G g__;
					return owner_.incom_.space();
				}
				virtual size_t get(uint8_t* _data, size_t _max_size) {
					G g__;
					return owner_.outcom_.get(_data, _max_size);
				}
				virtual bool put(uint8_t* _data, size_t _size) {
					G g__;
					return owner_.incom_.put(_data, _size);
				}
				virtual uint8_t get(void) {
					G g__;
					if (owner_.outcom_.count() > 0) {
						return owner_.outcom_.get();
					}
					else {
						return 0;
					}
				...
				virtual bool  put(uint8_t _data) {
					G g__;
					if (owner_.incom_.space() > 0) {
						owner_.incom_.put(_data);
						return true;
					}
					else {
						return false;

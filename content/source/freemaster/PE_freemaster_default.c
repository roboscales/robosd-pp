...
#ifndef FREEMASTER_DEFAULT_ADAPTER_ENABLED
#define FREEMASTER_DEFAULT_ADAPTER_ENABLED 1
#endif
#if FREEMASTER_DEFAULT_ADAPTER_ENABLED == 1
/*
void FMSTR_Isr(void)
{
...
{
	FMSTR_U8* ps = FMSTR_ADDR2PTR(nSrcAddr);
	FMSTR_U8* pd = FMSTR_ADDR2PTR(nDestAddr);
...
#define FMSTR_ADDRESS_OFFSET ((FMSTR_ADDR)0)
#endif

...
, {
	{
		...
		, {
			{ //range
				POWER_SUPPLY_PREFIX(VOLTAGE_MIN_LIM)
				, POWER_SUPPLY_PREFIX(VOLTAGE_MAX_LIM)
			}
			, 0
		}
		, 0
...
#define REGULATOR_MIN_LIM		POWER_SUPPLY_PREFIX(VOLTAGE_MIN_LIM)
#define REGULATOR_MAX_LIM		POWER_SUPPLY_PREFIX(VOLTAGE_MAX_LIM)

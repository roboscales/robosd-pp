...
#include "freemaster/PE_freemaster_protocol.h"
...
#if !FMSTR_USE_FASTREC
    /* any trigger? */
    pcm_pCompareFunc = (FMSTR_PCOMPAREFUNC)NULL;
...
static void FMSTR_Recorder2(void)
{
    ...
    if(!pcm_wRecFlags.flg.bIsStopping && pcm_pCompareFunc != (FMSTR_PCOMPAREFUNC)NULL)
    {

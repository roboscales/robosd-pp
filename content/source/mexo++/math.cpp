...
namespace mexo{
	...
	#define S(x) digit15::frac( (x))

	const digit15::number_t mcgenSineTable256[ sin_length_table + 1 ] =
	...
	digit15::number_t mcsinPIxLUT(digit15::number_t _value) {
		if (_value >= 0) {
			return (
			_value > S(0.5) ? 
	...
	digit15::number_t digit15::sin(digit15::number_t _angle) {
		return mcsinPIxLUT(_angle);
	}
	digit15::number_t digit15::cos(digit15::number_t _angle) {
